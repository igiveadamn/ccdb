        ...
        User.findByIdAndUpdate(id, user, {upsert: true}, function (err, user) {
            ...
            if (user.passwordChange) {
                ...
                postmark.send({
                    ...
                    To: user.username,
                    Subject: 'Please reset your ICED password',
                    HtmlBody: 'Please click on the link to reset your ICED password: <a href="' + process.env.ICES_SERVER + '#/password/'+ user.passwordChange +'">Reset password</a>',
                    Tag: 'reset password'
